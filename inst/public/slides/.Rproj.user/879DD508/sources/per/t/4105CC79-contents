...
course_site=function(url="../../index.html",title="Back to the summer school website",fill="#bcc0c4") {
  paste0('&nbsp;<a target="_self" href="',url,'"; title="',title,'">',icons::icon_style(icons::fontawesome("home"),scale=1,fill=fill,bottom="1em"),'</a>&nbsp;')
}

## Needs fiddling with this ##
binder_repo=function(url="https://mybinder.org/v2/gh/StatisticsHealthEconomics/stat0019_binder/main?urlpath=rstudio",title="Open the Binder VM",fill="#bcc0c4") {
  paste0('&nbsp;<a target="_self" href="',url,'"; title="',title,'"> <img src="../img/binder.svg" width="50" alt=""></a>&nbsp;')
}
##
...
bmhe=function(chapter=NULL) {
  ...
  paste0(icon::fontawesome("book"),' <i>Bayesian Methods in Health Economics</i>',txt_chapter,
         ' .button[<img src="../img/routledge.png" width="7%"> [Book website (CRC)](',book_links$bmhe$crc,')] .button[<i class="fab fa-firefox"></i> [Book website](',book_links$bmhe$site,')] .button[<i class="fab fa-github"></i> [Code](',book_links$bmhe$github,')]')
}
...
bugs_book=function(chapter=NULL) {
  ...
  paste0(icon::fontawesome("book"),' <i>The BUGS Book</i>',txt_chapter,
         ' .button[<img src="../img/routledge.png" width="10%"> [Book website](',book_links$bugs_book$crc,')]')
}
...
daniels=function(chapter=NULL) {
  ...
  paste0(icon::fontawesome("book"),' <i>Missing data in longitudinal studies</i>',txt_chapter,
         ' .button[<img src="../img/routledge.png" width="10%"> [Book website](',book_links$daniels$crc,')]')
}
...
esdm=function(chapter=NULL) {
  ...
  paste0(icon::fontawesome("book"),' <i>Evidence Synthesis for Decision Making in Healthcare</i>',txt_chapter,
         ' .button[<img src="../img/wiley.png" width="10%"> [Book website](',book_links$esdm$wiley,')]')
}
...
gelman_hill=function(chapter=NULL) {
  ...
  paste0(icon::fontawesome("book"),' <i>Data Analysis Using Regression and Multilevel/Hierarchical Models</i>',txt_chapter,
         ' .button[<img src="../img/cup.png" width="10%"> [Book website (CUP)](',book_links$gelman_hill$crc,')] .button[<i class="fab fa-firefox"></i> [Book website](',book_links$gelman_hill$site,')]')
}
...
kruschke=function(chapter=NULL) {
  ...
  paste0(icon::fontawesome("book"),' <i>Doing Bayesian Data Analysis</i>',txt_chapter,
         ' .button[<i class="fab fa-firefox"></i> [Book website](',book_links$kruschke$site,')]')
}
...
bacthc=function(chapter=NULL) {
  ...
  paste0(icon::fontawesome("book"),' <i>Bayesian approaches to clinical trials and health care evaluation</i>',txt_chapter,
         ' .button[<img src="../img/wiley.png" width="10%"> [Book website](',book_links$bacthc$wiley,')]')
}
...
briggs=function(chapter=NULL) {
  ...
  paste0(icon::fontawesome("book"),' <i>Decision Modelling for Health Economic Evaluation</i>',txt_chapter,
         ' .button[<img src="../img/oup-1.png" width="10%">  [Book website](',book_links$briggs$oup,')]')
}
