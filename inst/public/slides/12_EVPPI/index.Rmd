...
`r include_fig("residuals.png",width="65%")`
...
`r include_fig("residuals2.png",width="60%")`
...
knitr::include_url("http://savi.shef.ac.uk/SAVI/",height="560px")
```
...
.alignright[.small[`r icon::fontawesome("arrow-circle-right")` [Next lecture](../13_EVSI/index.html)]]